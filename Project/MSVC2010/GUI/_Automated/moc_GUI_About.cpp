...
struct qt_meta_stringdata_GUI_About_t {
    QByteArrayData data[5];
    char stringdata[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GUI_About_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GUI_About_t qt_meta_stringdata_GUI_About = {
    {
...
QT_MOC_LITERAL(4, 41, 9)
    ...
    "GUI_About\0OnDescription\0\0OnAuthorLicense\0"
    "OnContact\0"
};
...
const QMetaObject GUI_About::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GUI_About.data,
      qt_meta_data_GUI_About,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GUI_About.stringdata))
