...
struct qt_meta_stringdata_GUI_Main_xxxx_TextEditDialog_t {
    QByteArrayData data[6];
    char stringdata[78];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GUI_Main_xxxx_TextEditDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GUI_Main_xxxx_TextEditDialog_t qt_meta_stringdata_GUI_Main_xxxx_TextEditDialog = {
    {
...
QT_MOC_LITERAL(5, 65, 11)
    ...
    "GUI_Main_xxxx_TextEditDialog\0OnAccept\0"
    "\0OnTextChanged\0OnMenu_Load\0OnMenu_Save\0"
};
...
const QMetaObject GUI_Main_xxxx_TextEditDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GUI_Main_xxxx_TextEditDialog.data,
      qt_meta_data_GUI_Main_xxxx_TextEditDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GUI_Main_xxxx_TextEditDialog.stringdata))
