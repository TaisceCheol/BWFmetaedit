...
struct qt_meta_stringdata_GUI_Main_UndoDialog_t {
    QByteArrayData data[6];
    char stringdata[75];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GUI_Main_UndoDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GUI_Main_UndoDialog_t qt_meta_stringdata_GUI_Main_UndoDialog = {
    {
...
QT_MOC_LITERAL(5, 65, 8)
    ...
    "GUI_Main_UndoDialog\0currentItemChanged\0"
...
const QMetaObject GUI_Main_UndoDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GUI_Main_UndoDialog.data,
      qt_meta_data_GUI_Main_UndoDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GUI_Main_UndoDialog.stringdata))
