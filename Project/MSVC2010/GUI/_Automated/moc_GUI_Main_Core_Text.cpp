...
struct qt_meta_stringdata_GUI_Main_Core_Text_t {
    QByteArrayData data[1];
    char stringdata[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GUI_Main_Core_Text_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GUI_Main_Core_Text_t qt_meta_stringdata_GUI_Main_Core_Text = {
    {
...
const QMetaObject GUI_Main_Core_Text::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_GUI_Main_Core_Text.data,
      qt_meta_data_GUI_Main_Core_Text,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GUI_Main_Core_Text.stringdata))
