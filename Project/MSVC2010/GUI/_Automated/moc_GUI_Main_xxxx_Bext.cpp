...
struct qt_meta_stringdata_GUI_Main_xxxx_Bext_t {
    QByteArrayData data[3];
    char stringdata[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GUI_Main_xxxx_Bext_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GUI_Main_xxxx_Bext_t qt_meta_stringdata_GUI_Main_xxxx_Bext = {
    {
QT_MOC_LITERAL(0, 0, 18),
QT_MOC_LITERAL(1, 19, 8),
QT_MOC_LITERAL(2, 28, 0)
    },
    "GUI_Main_xxxx_Bext\0OnAccept\0\0"
};
...
const QMetaObject GUI_Main_xxxx_Bext::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GUI_Main_xxxx_Bext.data,
      qt_meta_data_GUI_Main_xxxx_Bext,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GUI_Main_xxxx_Bext.stringdata))
