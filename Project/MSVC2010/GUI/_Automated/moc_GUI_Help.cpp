...
struct qt_meta_stringdata_GUI_Help_t {
    QByteArrayData data[4];
    char stringdata[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_GUI_Help_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_GUI_Help_t qt_meta_stringdata_GUI_Help = {
    {
...
QT_MOC_LITERAL(3, 26, 4)
    ...
    "GUI_Help\0OnAnchorClicked\0\0link\0"
};
...
const QMetaObject GUI_Help::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GUI_Help.data,
      qt_meta_data_GUI_Help,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GUI_Help.stringdata))
